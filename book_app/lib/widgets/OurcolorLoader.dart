...
class OurColorLoader extends StatefulWidget {
  final List<Color> colors;
  final Duration duration;

  OurColorLoader({this.colors, this.duration});

  @override
  _OurColorLoaderState createState() =>
      _OurColorLoaderState(this.colors, this.duration);
}

class _OurColorLoaderState extends State<OurColorLoader>
